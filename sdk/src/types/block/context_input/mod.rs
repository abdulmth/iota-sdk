...
mod block_issuance_credeit;
mod commitment;
mod reward;

pub use self::block_issuance_credeit::BlockIssuanceCreditContextInput;
...
pub mod dto {
    ...
    use super::{
        block_issuance_credeit::dto::BlockIssuanceCreditContextInputDto, commitment::dto::CommitmentContextInputDto, *,
    };
    use crate::types::block::Error;
